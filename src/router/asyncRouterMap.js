...
},
{
  ...
  },
  {
    path: 'commodity',
    name: 'commodity',
    component: () => import('../views/device/commodity'),
    meta: { title: 'm.router.commodity', icon: 'el-icon-s-shop'},
    menu: 'commodity'
  },
  {
    path: 'order',
    ...
    meta: { title: 'm.router.order', icon: 'el-icon-s-finance'},
    menu: 'order'
  },
  {
    path: 'income',
    name: 'income',
    component: () => import('../views/device/income'),
    meta: { title: 'm.router.income', icon: 'el-icon-s-data'},
    menu: 'income'
  }
