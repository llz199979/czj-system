   ...
   */
    ...
    */
    ...
    downloadExcel({state}, page) {
      return new Promise((resolve, reject) => {
        let url = `https://pay.mjktech.com.cn/getEquipmentExport`;
        // let url = `https://pay.mjktech.com.cn/getEquipmentExport2?name=${page.name}`
        // +`&departmentName=${page.departmentName}`
        // +`&corporationName=${page.corporationName}`
        // +`&startTime=${page.startTime}&endTime=${page.endTime}`;
    ...
    getLeaderMassage({state}, page) {
      return new Promise((resolve, reject) => {
        let url = `https://pay.mjktech.com.cn/corporation/getLeadPersonalExportAll`;
        let token = getItem('token');
        axios({
          url: url,
          method: 'post',
    ...
    getStaffMassage({state}, page) {
      return new Promise((resolve, reject) => {
        let url = `https://pay.mjktech.com.cn/corporation/getPersonalExportAll`;
        let token = getItem('token');
        axios({
          url: url,
          method: 'post',
